            ...
            <div class=" container mx-auto my-auto">
                ...
                <div class=" flex-col flex">
                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="w-2/4 mt-28 text-center text-black text-3xl font-semibold font-josefin">{{ $facility->name }}</div>
                        <p class="w-5/12 mt-6 ml-16 text-xl text-right float-start font-josefin">{{ $facility->description_facility }}</p>
                        @else    
                        <img class="relative ml-20 rounded-xl bg-auto float-start w-5/12 h-72 mt-28"
                            src="{{ url('assets/img/facility/'.$facility->image) }}" alt="">
                        <div class="w-2/4 mt-28 text-center text-black text-3xl font-semibold font-josefin float-start">{{ $facility->name }}
                        </div>
                        <p class="float-start w-5/12 mt-6 ml-16 text-xl text-right float-start font-josefin">{{ $facility->description_facility }}</p>
                        @endif
                    </div>
                    @endforeach
                </div>
