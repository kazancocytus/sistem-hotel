...
<body>
    ...
    <div class=" bg-colorSecondary">
        ...
        <div class="block my-14 mx-10 w-auto p-6 bg-colorPrimary border border-gray-200 rounded-2xl shadow ">
            <div class=" pl-10 pb-7 pt-10 text-left text-black text-4xl font-semibold font-josefin">{{ $typeRoom->name }}</div>
            ...
            <div class=" mt-10 mb-6 px-10 py-2 text-sm text-left font-josefin">
                <div class=" relative row text-slate-500">
                    ...
                    <div class=" absolute bottom-0 right-0 w-3/12">
                        <div class=" mb-3">
                            <span class=" text-center font-josefin text-3xl font-bold text-colorgreen">${{ $typeRoom->price }}/
                                Night</span>
                        </div>
                        @if (Route::has('login'))
                        <div class=" ml-3">
                            <button class="right">
                                ...
                                @else
                                <a data-bs-toggle="modal" data-bs-target="#modalLogin" class="relative inline-flex items-center px-12 py-2 overflow-hidden text-lg font-josefin font-medium text-colorBg border-2 border-colorgreen rounded-full hover:text-white group hover:bg-gray-50">
                                @endauth
                                    <span
