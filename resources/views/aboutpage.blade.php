        ...
        <div class=" container">
            <div class="block my-24 mx-10 w-auto p-6 bg-colorPrimary border border-gray-200 rounded-2xl shadow ">
                ...
                <div class="my-10 mx-14 w-11/12 p-6 bg-colorPrimary border border-gray-200 rounded-2xl shadow ">
                    ...
                    <div class="flex items-center mb-1">
                        <div class=" ml-2 font-medium text-colorBg opacity-90">
                            <input class=" font-josefin border-b-2 border-b-colorThird rounded-xl border-t-0 border-r-0 border-l-0 drop-shadow-md" type="text" placeholder="Input Your Name..">
                        </div>
                    </div>
                    ...
                    <a href="#_" class=" ml-6 w-1/5 relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-colorBg transition duration-300 ease-out border-2 border-colorSecondary rounded-full shadow-md group">
                        ...
                        <span class="absolute flex items-center justify-center w-full h-full bg-colorThird text-co transition-all duration-300 transform group-hover:translate-x-full ease">Post!</span>
                        <span class="relative invisible">Button Text</span>
                    </a>
                    <!-- Rating -->
                    <div class="flex flex-row-reverse justify-end items-center ml-2 mt-4">
                        <input id="hs-ratings-readonly-1" type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0" name="hs-ratings-readonly" value="1">
                        ...
                        <input id="hs-ratings-readonly-2" type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0" name="hs-ratings-readonly" value="2">
                        ...
                        <input id="hs-ratings-readonly-3" type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0" name="hs-ratings-readonly" value="3">
                        ...
                        <input id="hs-ratings-readonly-4" type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0" name="hs-ratings-readonly" value="4">
                        ...
                        <input id="hs-ratings-readonly-5" type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0" name="hs-ratings-readonly" value="5">
